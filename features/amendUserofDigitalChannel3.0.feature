@PCM @AmendUser @Regression
Feature: Amend User of Digital Channel
  As an authorised user,
  I want to be able to download, complete and upload a signed PCM Request Form through Digital Self Service,
  so that user can Amend the details or access type for your digital channel users.
  #-----------------------------------------------------------------------------------------------------------------------


  @SmokeTestingMockUI
  Scenario:Amend User of Digital Channel - Create and View service request
    Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
    When The user navigate to the "Amend User of Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Amend User of Digital Channel"
      | Title       | Amend User of Digital Channel (AU)                                    |
      | Description | Amend the details or access type for your digital channel users. |
    ...
    Then The application should display the "Instructions to download and complete the form" for "Add User to Digital Channel"
      ...
      | instructions_step1.1_text   | Download the form by clicking the button below. Note: contact your administrator if you need to amend an ANZ Transactive – Global company managed user.                                                                                               |
    ...
    Then The application should display the "download form button" for "Amend User of Digital Channel"
      | download_form | Download the Amend User of Digital Channel form |
    ...
    Then The application should display the "Your Reference section" for "Amend User of Digital Channel"
    ...
    Then The application should display following fields "under Select Legal Entity section"
      ...
      | LegalEntity-field            |
    Then The application should display the "Legal Entity details" for "Amend User of Digital Channel service request"
    ...
    Then The application should display following fields "Amend User of Digital Channel SR confirmation pop-up"
      | field_name                 |
      | request_status             |
      | requestId                  |
      | view_request_link          |
      ...
      | submitted_txt              |
      | submitted_tickMark         |
    Then The application should display the "Confirmation pop-up detail" for "Amend User of Digital Channel SR"
    ...
    Then The application should display the "service request Header detailsin view mode" for "Amend User of Digital Channel SR"
      | Title       | Amend User of Digital Channel (AU)                                    |
      | Description | Amend the details or access type for your digital channel users. |
    ...
    Then The application should display the "Summary Information" for "Service request"
      ...
      | Important_Information | Please refer to your Cash Product Fee Schedule for any Fee and/or Charges that may apply to this service. |
        Then The application should display the "Legal Entity details" for "Amend User of Digital Channel SR"
    ...
    Then The application should display the "Audit History Pop-up details" for "Amend User of Digital Channel SR"
    ...
    Then The application should display the "Comments and Supporting Documents section" for "Amend User of Digital Channel service request"
  ...
  @SmokeTestingMockUI
  Scenario:Amend User of Digital Channel - Create and Search service request
    Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
    When The user navigate to the "Amend User of Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Amend User of Digital Channel"
      | Title       | Amend User of Digital Channel (AU)                                    |
    ...
    Then The application should display the "Summary Information" for "Service request"
      ...
      | Summary_Info_Requestedby_txt   | Requested by        |
      | Summary_Info_RequestStatus_txt | Request Status      |
    Then The application should display the "Important Information Section" for "Amend user of digital channel SR"
      | Important_Information | Please refer to your Cash Product Fee Schedule for any Fee and/or Charges that may apply to this service. |
    Then The application should display the "Legal Entity details" for "Amend User of Digital Channel SR"
      | Legal_Entity_Summary | Legal Entity |
      | Legal_Entity_Name    | Legal Entity |
...
#    Scenario:Amend User of Digital Channel - Header and Description
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should display the "service request Header details" for "Amend User of Digital Channel"
#       | Add_user_Title       | Amend User of Digital Channel                                    |
#       | Add_user_Description | Amend the details or access type for your digital channel users. |
#     Then The application shows the "cancel" button



#     Scenario:Amend User of Digital Channel - Step 1: Download and Complete Content
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
# Then The application should display the "Instructions to download and complete the form" for "Add User to Digital Channel"
#       | instructions_header         | Step 1: Download and Complete                                                                                                                                                                                                                          |
...
#     Scenario:Amend User of Digital Channel - Important Information
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf    |
...
#     Scenario:Amend User of Digital Channel - Display Your Reference section
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf    |
...
#     Scenario:Amend User of Digital Channel - Display the legal entity
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf    |
...
#     Scenario:Amend User of Digital Channel - Select the legal entity from drop down
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf    |
...
#       | Add_user_Title       | Amend User of Digital Channel                                                                              |
#       | Add_user_Description | Add users to your digital channels with the option of nominating authorised persons to sign documentation. |
...
#     Scenario:Amend User of Digital Channel - Select the legal entity from search pop-up
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf    |
...
#     Scenario:Amend User of Digital Channel -  Upload Form - Display Upload File Component
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
...
#     Then The application should display the "file upload component details" for "Add User service request"
...
#   @SmokeTesting
#     Scenario:Amend User of Digital Channel - Confirmation Pop-Up Message - View SR Details
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf    |
...
#     Scenario:Amend User of Digital Channel - Confirmation Pop-Up Message - OK
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf  |
...
#       Scenario:Amend User of Digital Channel - Confirmation Pop-Up Message - Raise Another Service Request
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf  |
...
#       Scenario:Amend User of Digital Channel - Multiple files upload
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf    |
...
#       Scenario:Amend User of Digital Channel - Duplicate files upload
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf  |
...
#       Scenario:Amend User of Digital Channel - Mixed files upload
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf      |
...
#       Scenario:Amend User of Digital Channel - Invalid file format upload
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
...
#    Scenario:DTFAU-232   Amend User of Digital Channel - Submit Request - Submit with No File(s) Uploaded
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     And The user navigate to the "Amend User of Digital Channel" service request screen
...
#       Scenario:Amend User of Digital Channel - Morethan 10 files
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1  | //resources//input//Test-pdf.pdf    |
...
#   #   Scenario:Amend User of Digital Channel - Morethan 10 MB file size
#   #   Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#   #   When The user navigate to the "Amend User of Digital Channel" service request screen
#   #   Then The application should allow user to select and upload one or more files from computer
...
#       Scenario:Amend User of Digital Channel - Without Legal Entity
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf  |
...
#     Scenario:Amend User of Digital Channel - Remove Uploaded File
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf  |
...
#     Scenario:Amend User of Digital Channel - User does not have email address
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
...
#     Scenario:Amend User of Digital Channel - User does not enter an email address
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload single file
#       | filepath | //resources//input//Test-pdf.pdf |
...
#      Scenario:Amend User of Digital Channel - User enters invalid email address
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload single file
#       | filepath | //resources//input//Test-pdf.pdf |
...
#      Scenario:Amend User of Digital Channel - Closing the email modal
#     Given I am an authorised user with permission to create an "Amend User of Digital Channel" service request
#     When The user navigate to the "Amend User of Digital Channel" service request screen
#     Then The application should allow user to select and upload single file
#       | filepath | //resources//input//Test-pdf.pdf |
