@AmendStatementAddress @PCM @Regression @ACM
Feature: Amend Statement Address
  As an authorised user,
  I want to be able to download, complete and upload a signed ACM Request Form through Digital Self Service,
  so that user can Amend the statement address for your accounts.
  #-----------------------------------------------------------------------------------------------------------------------


  @SmokeTestingMockUI
  Scenario:Amend Statement Address - Create and View service request
    Given I am an authorised user with permission to create an "Amend Statement Address" service request
    When The user navigate to the "Amend Statement Address" service request screen
    Then The application should display the "service request Header details" for "Amend Statement Address"
      | Title       | Amend Statement Address (AU)                        |
      | Description | Amend the statement address for your accounts. |
    ...
    Then The application should display the "download form button" for "Amend Statement Address"
      | download_form | Download the Amend Statement Address form |
    ...
    Then The application should display the "Your Reference section" for "Amend Statement Address"
    ...
    Then The application should display the "Your Reference section" for "Service Request"
    ...
    Then The application should display following fields "Amend Statement Address SR confirmation pop-up"
      | field_name                 |
      | request_status             |
      | requestId                  |
      | view_request_link          |
      ...
      | submitted_txt              |
      | submitted_tickMark         |
    Then The application should display the "Confirmation pop-up detail" for "Amend Statement Address SR"
    ...
    Then The application should display the "service request Header detailsin view mode" for "Amend Statement Address SR"
      | Title       | Amend Statement Address (AU)                       |
      | Description | Amend the statement address for your accounts. |
    ...
    Then The application should display the "Audit History Pop-up details" for "Amend Statement Address SR"
    ...
    Then The application should display the "Comments and Supporting Documents section" for "Amend Statement Address service request"
  ...
  @SmokeTestingMockUI
  Scenario:Amend Statement Address - Create and Search service request
    Given I am an authorised user with permission to create an "Amend Statement Address" service request
    When The user navigate to the "Amend Statement Address" service request screen
    Then The application should display the "service request Header details" for "Amend Statement Address"
      | Title       | Amend Statement Address (AU)                        |
...
#     Scenario: Amend Statement Address - Header and Description
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should display the "service request Header details" for "Amend Statement Address"
#       | Title       | Amend Statement Address                                                                                |
#       | Description | Amend the statement address for your accounts.|
#     Then The application shows the "cancel" button


#     Scenario:Amend Statement Address - Step 1: Download and Complete Content
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#  Then The application should display the "Instructions to download and complete the form" for "Add User to Digital Channel"
#       | instructions_header         | Step 1: Download and Complete                                                                                                                                                                                                                          |
...
#     Scenario: Amend Statement Address - Display Your Reference section
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf    |
...
#     Scenario: Amend Statement Address - Display the legal entity
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf    |
...
#       | LegalEntity-field            |
#     Then The application should display the "Legal Entity details" for "Amend Statement Address service request"
...
#     Scenario: Amend Statement Address - Select the legal entity from drop down
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf    |
...
#     Then The application should display the "service request Header detailsin view mode" for "Amend Statement Address SR"
#       | Title       | Amend Statement Address                                                                                |
#       | Description | Amend the details of, or suspend, your periodical payments.|
#     Then The application should display the "Summary Information" for "Amend Statement Address service request"
#       | Summary_Info_header            | Summary Information |
#       | Summary_Info_RequestID_txt     | Request ID          |
...
#     Then The application should display the "Legal Entity details" for "Amend Statement Address SR"
#       | Legal_Entity_Summary | Legal Entity |
#       | Legal_Entity_Name    | Legal Entity |
#       | Legal_Entity_Value   | NSWG         |


#     Scenario:Amend Statement Address - Select the legal entity from search pop-up
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf    |
...
#     Scenario:Amend Statement Address -  Upload Form - Display Upload File Component
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
...
#     Then The application should display the "file upload component details" for "Amend Statement Address service request"
...
#     Scenario:Amend Statement Address - Confirmation Pop-Up Message - View SR Details
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf    |
...
#     Scenario:Amend Statement Address - Confirmation Pop-Up Message - OK
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf  |
...
#     Scenario:Amend Statement Address - Confirmation Pop-Up Message - Raise Another Service Request
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf  |
...
#     Scenario:Amend Statement Address - Multiple files upload
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf    |
...
#     Scenario:Amend Statement Address - Duplicate files upload
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf  |
...
#     Scenario:Amend Statement Address - Mixed files upload
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf  |
...
#     Scenario:Amend Statement Address - All Bad files upload
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
...
#     Scenario:Amend Statement Address - Submit Request - Submit with No File(s) Uploaded
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     And The user navigate to the "Amend Statement Address" service request screen
...
#     Scenario:Amend Statement Address - Morethan 10 files
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1  | //resources//input//Test-pdf.pdf    |
...
#   # @morethan10MBsize
#   #   Scenario:Amend Statement Address - Morethan 10 MB file size
#   #   Given I am an authorised user with permission to create an "Amend Statement Address" service request
#   #   When The user navigate to the "Amend Statement Address" service request screen
#   #   Then The application should allow user to select and upload one or more files from computer
...
#     Scenario:Amend Statement Address - Without Legal Entity
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf  |
...
#     Scenario: Amend Statement Address - Remove Uploaded File
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload one or more files from computer
#       | filepath1 | //resources//input//Test-pdf.pdf  |
...
#     Scenario:Amend Statement Address - User does not have email address
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
...
#     Scenario:Amend Statement Address - User does not enter an email address
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload single file
#       | filepath | //resources//input//Test-pdf.pdf |
...
#     Scenario:Amend Statement Address - User enters invalid email address
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload single file
#       | filepath | //resources//input//Test-pdf.pdf |
...
#     Scenario:Amend Statement Address - Closing the email modal
#     Given I am an authorised user with permission to create an "Amend Statement Address" service request
#     When The user navigate to the "Amend Statement Address" service request screen
#     Then The application should allow user to select and upload single file
#       | filepath | //resources//input//Test-pdf.pdf |
