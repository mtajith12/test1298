@PCM @add-userNew @Regression @20.6.1
Feature: Add User to Digital Channel
  As an authorised user,
  I want to be able to download, complete and upload a signed PCM Request Form through Digital Self Service,
  so that user can Add users to your digital channels with the option of nominating authorised persons to sign documentation.
  #-----------------------------------------------------------------------------------------------------------------------

  @add-userNew1
  Scenario:Add User to Digital Channel - Create and View service request
    ...
    Then The application should display the "download form button" for "Add User to Digital Channel"
      | download_form | Download the Add User to Digital Channel form |
    ...
    Then The application should display the "Your Reference section" for "Add User to Digital Channel"
    ...
    Then The application should display following fields "under Select Legal Entity section"
      ...
      | LegalEntity-field            |
    Then The application should display the "Legal Entity details" for "Add User to Digital Channel service request"
    ...
    Then The application should display following fields "Add User to Digital Channel SR confirmation pop-up"
      | field_name                 |
      | request_status             |
      | requestId                  |
      | view_request_link          |
      ...
      | submitted_txt              |
      | submitted_tickMark         |
    Then The application should display the "Confirmation pop-up detail" for "Add User to Digital Channel SR"
    ...
    Then The application should display the "service request Header detailsin view mode" for "Add User to Digital Channel SR"
      | Title       | Add User to Digital Channel (AU)                                                                           |
      | Description | Add users to your digital channels with the option of nominating authorised persons to sign documentation. |
    Then The application should display the "viewAuditHistory" button
    Then The application should display the "Close" button
    Then The application should display the "Summary Information" for "Add User to Digital Channel service request"
    ...
    Then The application should display the "Legal Entity details" for "Add User to Digital Channel SR"
    ...
    Then The application should display the "Comments and Supporting Documents section" for "Add User to Digital Channel service request"
  ...
  @add-userNew2
  Scenario:Add User to Digital Channel - Create and Search service request
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  @add-userNew4
  Scenario:Add User to Digital Channel - Step 1: Download ,Complete Content ,Display Your Reference section & legal entity
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  @add-userNew8
  Scenario:Add User to Digital Channel - Select the legal entity from drop down
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
    ...
    Then The application should display the "service request Header detailsin view mode" for "Add User SR"
      | Add_user_Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  @LE1
  Scenario:Add User to Digital Channel - Select the legal entity from search pop-up
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  @tooltip
  Scenario:Add User to Digital Channel -  Upload Form - Display Upload File Component
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  @SmokeTesting3214
  Scenario:Add User to Digital Channel - Confirmation Pop-Up Message - View SR Details
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  Scenario:Add User to Digital Channel - Confirmation Pop-Up Message - OK
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  Scenario:Add User to Digital Channel - Confirmation Pop-Up Message - Raise Another Service Request
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  Scenario:Add User to Digital Channel - Multiple files upload
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  @Duplicate_123
  Scenario:Add User to Digital Channel - Duplicate files upload
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  @fileuploadNegative
  Scenario:Add User to Digital Channel - Mixed files upload
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  @Invalidfile
  Scenario:Add User to Digital Channel - Invalid file format upload
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  Scenario:Add a User to a Digital Channel - Submit Request - Submit with No Files Uploaded
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    And The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
      | Description | Add users to your digital channels with the option of nominating authorised persons to sign documentation. |
    Then The application shows the "cancel" button
  ...
  @fileuploadNegative3
  Scenario:Add User to Digital Channel - Without Legal Entity
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  @fileuploadNegative4
  Scenario:Add User to Digital Channel - Remove Uploaded File
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  Scenario:Add a User - Submit Comment - Successful
    ...
    Then The user searches stored service request with request type "Add User to Digital Channel" and selects it
  ...
  Scenario:Add a User - adduser#comments#attachments#Close#No
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  @ReopenPCM
  Scenario: Add User to Digital Channel - Reopen PCM service request
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
    ...
    Then The application should display the "Reopen" button
    Then The application should display the "Reopen model window" for "Add User to Digital Channel request"
  ...
  @ReopenPCM3
  Scenario: Add User to Digital Channel - Reopen modal/pop-up validations
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  @CancelRequest
  Scenario: Add User to Digital Channel - Cancel PCM service request
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
   ...
   # Then The user searches stored service request with request type "Add User to Digital Channel" and selects it
    ...
    Then The application should display the "status as Approved" for "SR"
      ...
      | Summary_Info_Requestedon_txt     | Requested on        |
      | Summary_Info_Requestedby_txt     | Requested by        |
      | Summary_Info_RequestStatus_value | Cancelled           |




  @CancelRequest1
  Scenario: Add User to Digital Channel - Instant Cancel PCM service request
    Given I am an authorised user with permission to create an "Add User to Digital Channel" service request
    When The user navigate to the "Add User to Digital Channel" service request screen
    Then The application should display the "service request Header details" for "Add User to Digital Channel"
      | Title       | Add User to Digital Channel (AU)                                                                           |
  ...
  #  When The user Clicks the "Close" button
   # Then The user searches stored service request with request type "Add User to Digital Channel" and selects it
    ...
    Then The application should display the "status as Approved" for "SR"
      ...
      | Summary_Info_Requestedon_txt     | Requested on        |
      | Summary_Info_Requestedby_txt     | Requested by        |
      | Summary_Info_YourReference_value | Cancelled           |
    Then The application does not show "Cancel Request" button
